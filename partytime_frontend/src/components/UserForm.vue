...
export default {
  ...
  methods: {
    async register (e) {
      ...
      const jsonData = JSON.stringify(data) // Transformando o objeto javascript em json

      await fetch("http://localhost:8003/api/auth/register", {
        method: "POST",
    ...
    async update(e) {
      ...
      await fetch("http://localhost:8003/api/user", {
          method: "PATCH",
          headers: { 
